...
public class DraggableGate : DraggableObject
{
	#region Variables
	...
	public override void OnDragged(Vector3 worldPos)
	{
		...
		mouseWorldMovement.y = (worldPos - startMouseWorldPos).y;
	...
	{
		this.Log("OnReleased \"" + name + "\" " + worldPos, DebugLogLevel.VeryDetailed);
